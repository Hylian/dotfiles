...
## Type: Dict
# c.bindings.key_mappings = {'<Ctrl-6>': '<Ctrl-^>', '<Shift-Enter>': '<Return>', '<Ctrl-M>': '<Return>', '<Ctrl-[>': '<Escape>', '<Ctrl-J>': '<Return>', '<Enter>': '<Return>', '<Ctrl-Enter>': '<Ctrl-Return>', '<Shift-Return>': '<Return>'}
...
## Type: Dict
# c.content.javascript.log = {'info': 'debug', 'error': 'debug', 'unknown': 'debug', 'warning': 'debug'}
...
## Type: Font
#c.fonts.completion.category = 'bold 4pt monospace'

## Font used in the completion widget.
## Type: Font
#c.fonts.completion.entry = '4pt monospace'
...
## Type: Font
#c.fonts.hints = 'bold 4pt monospace'
...
## Type: Padding
# c.tabs.indicator_padding = {'bottom': 2, 'left': 0, 'right': 4, 'top': 2}
