...
# vim + fzf
vim-fzf() {
fdfind --max-depth 1 --type f | fzf --ansi \
    --color prompt:green \
    --prompt "nvim> " \
    --header "" \
    --height '40%' \
...
export FZF_DEFAULT_OPTS='--color=bg:#fffbef,bg+:#f3f5d9,fg:#5c6a72,fg+:#5c6a72,border:#8da101,spinner:#f85552,hl:#f85552,header:#dfa000,info:#35a77c,pointer:#f85552,marker:#f85552,preview-bg:#fffbef,prompt:#fffbef,hl+:#fa8987'
